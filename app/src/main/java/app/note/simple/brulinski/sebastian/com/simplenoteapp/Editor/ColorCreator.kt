 ...
 */
class ColorCreator(private val R: Int, private val G: Int, private val B: Int, private val ctx: Activity) {
    ...
    private fun saveToSharedPref() {
        val preferences: SharedPreferences = ctx.getPreferences(0)
